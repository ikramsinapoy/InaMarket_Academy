...
function CardDetailClass() {
  return (
    <div className='flex items-center justify-between bg-pink rounded-xl p-7 mb-9'>
        <div className="">
            ...
            <h4 className='text-3xl font-Montserrat font-semibold text-black mb-2.5'>Marketing Guide 101</h4>

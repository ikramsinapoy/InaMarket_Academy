...
function ClassInformation() {
  return (
    <div>
        <ul className='flex gap-8 overflow-auto lg:gap-16 border-b border-gray-light pb-3'>
            <li>
                <a href='#kelas' className='font-Inter font-semibold text-gray hover:text-black active:text-black text-base cursor-pointer'>Detail Kelas</a>
            </li>
            <li>
                <a href='#tujuanPembelajaran' className='font-Inter font-semibold text-gray hover:text-black active:text-black text-base cursor-pointer'>Tujuan Pembelajaran</a>
            </li>
            <li>
                <a href='#silabus' className='font-Inter font-semibold text-gray hover:text-black active:text-black text-base cursor-pointer'>Silabus</a>
            </li>
            <li>
                <a href='#testimoni' className='font-Inter font-semibold text-gray hover:text-black active:text-black text-base cursor-pointer'>Testimoni</a>
            </li>
        </ul>
        <div className='mt-8 mb-6'>
            <h3 className='font-Inter font-semibold text-2xl text-black mb-3' id='kelas'>Detail Kelas</h3>
        ...
        <div className='mb-6'>
            <h3 className='font-Inter font-semibold text-2xl text-black mb-3' id='tujuanPembelajaran'>Tujuan Pembelajaran Kelas</h3>
            <p className='font-Inter text-black text-sm'>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
            </p>
        ...
        <div className='mb-6'>
            <h3 className='font-Inter font-semibold text-2xl text-black mb-3' id='silabus'>Silabus</h3>

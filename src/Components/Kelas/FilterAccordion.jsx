            ...
            <div class="accordion-item border-t-0 border-l-0 border-r-0 rounded-none bg-white border border-gray-200">
                ...
                aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body py-4 px-5">
                        ...
                        <label for="design_grafis">Design Grafis</label><br></br>

                        <input type="checkbox" name="branding" value="branding"></input>
                        <label for="vehicle1">Branding</label><br></br>

                        <input type="checkbox" name="marketing" value="marketing"></input>
                        <label for="vehicle1">Marketing</label><br></br>

                        <input type="checkbox" name="java" value="java"></input>
                        <label for="vehicle1">Java</label><br></br>

                        <input type="checkbox" name="frontend" value="frontend"></input>
                        <label for="vehicle1">Front End Developers</label><br></br>

                        <input type="checkbox" name="backend" value="backend"></input>
                        <label for="vehicle1">Back End Developers</label><br></br>
                    </div>
                    <div class="accordion-body py-4 px-5">

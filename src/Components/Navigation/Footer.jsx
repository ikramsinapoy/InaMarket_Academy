...
function Footer() {
  return (
    <div>
      <footer class="text-center lg:text-left bg-gray-100 text-gray-600 bg-secondary">
        <div class="mx-6 py-10 text-center md:text-left md:w-9/12 md:mx-auto">
          <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="">
              ...
              <p class="mb-4 flex items-center justify-center md:justify-start">
                <a href="#!" class="text-gray flex items-center gap-2"><img src={ina_market} className='w-6'/> Ina Market</a>
              </p>
              <p class="mb-4 flex items-center justify-center md:justify-start">
                <a href="#!" class="text-gray flex items-center gap-2"><img src={ina_tour} className='w-6'/> Ina Tour</a>
              </p>
              <p class="mb-4 flex items-center justify-center md:justify-start">
                <a href="#!" class="text-gray flex items-center gap-2"><img src={logo} className='w-6'/> Ina Academy</a>
              </p>
            </div>
        ...
        <div class="text-center p-6 bg-gray-200 text-black border-t border-primary md:w-9/12 md:mx-auto">
          <span>Copyright 2022 © InaMarket. All Right Reserved</span>
